...
Rscript src/9GP_merge.R $INPUT.HLA_A $INPUT2.HLA_A $INPUT3.HLA_A $INPUT4.HLA_A $INPUT5.HLA_A $INPUT6.HLA_A $INPUT7.HLA_A $INPUT8.HLA_A $INPUT9.HLA_A A
Rscript src/9GP_merge.R $INPUT.HLA_B $INPUT2.HLA_B $INPUT3.HLA_B $INPUT4.HLA_B $INPUT5.HLA_B $INPUT6.HLA_B $INPUT7.HLA_B $INPUT8.HLA_B $INPUT9.HLA_B B
Rscript src/9GP_merge.R $INPUT.HLA_C $INPUT2.HLA_C $INPUT3.HLA_C $INPUT4.HLA_C $INPUT5.HLA_C $INPUT6.HLA_C $INPUT7.HLA_C $INPUT8.HLA_C $INPUT9.HLA_C C
Rscript src/9GP_merge.R $INPUT.HLA_DRB1 $INPUT2.HLA_DRB1 $INPUT3.HLA_DRB1 $INPUT4.HLA_DRB1 $INPUT5.HLA_DRB1 $INPUT6.HLA_DRB1 $INPUT7.HLA_DRB1 $INPUT8.HLA_DRB1 $INPUT9.HLA_DRB1 DRB1
Rscript src/9GP_merge.R $INPUT.HLA_DQA1 $INPUT2.HLA_DQA1 $INPUT3.HLA_DQA1 $INPUT4.HLA_DQA1 $INPUT5.HLA_DQA1 $INPUT6.HLA_DQA1 $INPUT7.HLA_DQA1 $INPUT8.HLA_DQA1 $INPUT9.HLA_DQA1 DQA1
Rscript src/9GP_merge.R $INPUT.HLA_DQB1 $INPUT2.HLA_DQB1 $INPUT3.HLA_DQB1 $INPUT4.HLA_DQB1 $INPUT5.HLA_DQB1 $INPUT6.HLA_DQB1 $INPUT7.HLA_DQB1 $INPUT8.HLA_DQB1 $INPUT9.HLA_DQB1 DQB1
Rscript src/9GP_merge.R $INPUT.HLA_DPA1 $INPUT2.HLA_DPA1 $INPUT3.HLA_DPA1 $INPUT4.HLA_DPA1 $INPUT5.HLA_DPA1 $INPUT6.HLA_DPA1 $INPUT7.HLA_DPA1 $INPUT8.HLA_DPA1 $INPUT9.HLA_DPA1 DPA1
Rscript src/9GP_merge.R $INPUT.HLA_DPB1 $INPUT2.HLA_DPB1 $INPUT3.HLA_DPB1 $INPUT4.HLA_DPB1 $INPUT5.HLA_DPB1 $INPUT6.HLA_DPB1 $INPUT7.HLA_DPB1 $INPUT8.HLA_DPB1 $INPUT9.HLA_DPB1 DPB1
