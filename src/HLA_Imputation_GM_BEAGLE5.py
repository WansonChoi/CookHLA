...
class HLA_Imputation_GM_BEAGLE5(object):
    ...
    def IMPUTE(self, _out, _MHC_QC_VCF, _REF_PHASED_VCF, _aver_erate, _Refined_Genetic_Map, _window, _overlap, _ne, _nthreads):
        ...
        if self.FLAG_AdaptiveGeneticMap: ### With Adatpive Genetic Map
            ...
            command = '{} gt={} ref={} out={} impute=true gp=true err={} map={} ne=10000 nthreads={}'.format(
                self.BEAGLE5, _MHC_QC_VCF, _REF_PHASED_VCF, OUT, aver_erate, _Refined_Genetic_Map, _nthreads)
            # print(command)
            ...
            command = '{} \
                        ...
                        gp=true \
                        nthreads={}'.format(
                self.BEAGLE5, _MHC_QC_VCF, _REF_PHASED_VCF, OUT, _nthreads)
            # print(command)
    ...
    def IMPUTE_HapMap_Map(self, _out, _MHC_QC_VCF, _REF_PHASED_VCF, _window, _overlap, _ne, _nthreads):
        ...
        command = '{} \
                    ...
                    map={} \
                    nthreads={}'.format(
            self.BEAGLE5, _MHC_QC_VCF, _REF_PHASED_VCF, OUT, self.HapMap_Map, _nthreads)
        # print(command)
